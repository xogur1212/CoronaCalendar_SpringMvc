...
public class ApiController {
   ...
   public String apiCall(String date) throws IOException {
       ...
       urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=TM5yJHtsMToUZuRO3X8KoLES2AfVt2fBK4XPLXKI%2F5svpzB3s%2FoywqcOZB3Zh2OCHjqudgY0b%2Bkqlqb4FdZ%2BOg%3D%3D"); /*Service Key*/
